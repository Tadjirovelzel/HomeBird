...
const char* password = "FA9694C7FEC3";
...
// MQTT details
const char* broker = "16c8ca6fc79543699af71365bfeed7bf.s2.eu.hivemq.cloud";                    // Public IP address or domain name
const char* mqttUsername = "nestwachtnodered";  // MQTT username
const char* mqttPassword = "__PWRD__";          // MQTT password
const char* deviceOne = "device/1/measurement"; //topic
...
//String APN = "random-bs";//"smartsites.t-mobile";
String simPIN = "0000";
...
void loop(){
  ...
  if (now - lastMsg > 30000) {
    ...
    temperature = 50.0;//bme.readTemperature();   
    ...
    mqtt.publish(deviceOne, tempString); 
  }
  mqtt.loop();
  printCurrentTime();
  Serial2.write(1);
